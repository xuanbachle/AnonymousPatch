...
public class LightweightMessageFormatterTest extends TestCase {
  public static void main(String[] args) throws Exception {
    LightweightMessageFormatterTest t = new LightweightMessageFormatterTest();
    //t.testFormatErrorSpaceEndOfLine1();
    //t.testFormatErrorSpaceEndOfLine2();
    t.testFormatErrorSpaces();
    t.testFormatErrorTabs();
    //t.testOneLineRegion();
    //t.testOnlyOneEmptyLine();
    //t.testTwoEmptyLines();
  }
